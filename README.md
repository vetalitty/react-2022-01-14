...
3. Дописать обратотку **LOAD_REVIEWS** в **reviews** редьюсере
...
1. Сделать reviews/menu отдельными роутами (**/restaurants/:restId/reviews**)
2. Сделать редиректы со **/** и с **/restaurants/:restId** на страницу ресторана с меню
